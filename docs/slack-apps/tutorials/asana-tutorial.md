...
![slack-apps/tutorials/asana-tutorial/slashcommand.png](/docs/img/slack-apps/tutorials/asana-tutorial/slashcommand.png)

3. Go to **Features -> OAuth & Permissions** and add the following scopes to
   your app: `chat:write`, `chat:write.public`, `commands.`

![slack-apps/tutorials/asana-tutorial/permissions.png](/docs/img/slack-apps/tutorials/asana-tutorial/permissions.png)
...
![slack-apps/tutorials/asana-tutorial/newprojecterror.png](/docs/img/slack-apps/tutorials/asana-tutorial/newprojecterror.png)
...
![slack-apps/tutorials/asana-tutorial/newproject404.png](/docs/img/slack-apps/tutorials/asana-tutorial/newproject404.png)
...
![slack-apps/tutorials/asana-tutorial/trace.png](/docs/img/slack-apps/tutorials/asana-tutorial/trace.png)

4. You will see a text field in the body of the trace data. Use
   `request.body.text` to set your project name.

![slack-apps/tutorials/asana-tutorial/projectname.png](/docs/img/slack-apps/tutorials/asana-tutorial/projectname.png)
...
![slack-apps/tutorials/asana-tutorial/createProject.png](/docs/img/slack-apps/tutorials/asana-tutorial/createProject.png)

6. Try your Slash command again and then check Asana - your new project will be
   there!

![slack-apps/tutorials/asana-tutorial/asanaproject.png](/docs/img/slack-apps/tutorials/asana-tutorial/asanaproject.png)
...
![slack-apps/tutorials/asana-tutorial/textexample.png](/docs/img/slack-apps/tutorials/asana-tutorial/textexample.png)
...
![slack-apps/tutorials/asana-tutorial/notes.png](/docs/img/slack-apps/tutorials/asana-tutorial/notes.png)
...
![slack-apps/tutorials/asana-tutorial/projectsdatastore.png](/docs/img/slack-apps/tutorials/asana-tutorial/projectsdatastore.png)
...
![slack-apps/tutorials/asana-tutorial/populatedb.png](/docs/img/slack-apps/tutorials/asana-tutorial/populatedb.png)
...
![slack-apps/tutorials/asana-tutorial/taskandproject.png](/docs/img/slack-apps/tutorials/asana-tutorial/taskandproject.png)

5. Create a new function called `lookUpProjectID` and then use `DB::queryOne` to
   grab the id based on the `projectName`.

![slack-apps/tutorials/asana-tutorial/lookupprojectid.png](/docs/img/slack-apps/tutorials/asana-tutorial/lookupprojectid.png)

6. Use a match statement to handle both the success and failure (couldn't find
   the project name in the db) case.

![slack-apps/tutorials/asana-tutorial/match.png](/docs/img/slack-apps/tutorials/asana-tutorial/match.png)

7. Use your new function your HTTP POST handler.

![slack-apps/tutorials/asana-tutorial/lookupid.png](/docs/img/slack-apps/tutorials/asana-tutorial/lookupid.png)

8. Call the slash command again and check Asana - a new task should be there.

![slack-apps/tutorials/asana-tutorial/newesttask.png](/docs/img/slack-apps/tutorials/asana-tutorial/newesttask.png)
...
![slack-apps/tutorials/asana-tutorial/newmodal.png](/docs/img/slack-apps/tutorials/asana-tutorial/newmodal.png)

2. Turn Interactivity on via **Features -> Interactivity and Shortcuts** and
   specify a URL for the interaction to be sent to:

![slack-apps/tutorials/asana-tutorial/interactivity.png](/docs/img/slack-apps/tutorials/asana-tutorial/interactivity.png)
...
![slack-apps/tutorials/asana-tutorial/triggerid.png](/docs/img/slack-apps/tutorials/asana-tutorial/triggerid.png)

6. Format your header - you will need the Slack token you grabbed earlier in the
   set-up process.

![slack-apps/tutorials/asana-tutorial/header.png](/docs/img/slack-apps/tutorials/asana-tutorial/header.png)
...
![slack-apps/tutorials/asana-tutorial/json1.png](/docs/img/slack-apps/tutorials/asana-tutorial/json1.png)

![slack-apps/tutorials/asana-tutorial/json2.png](/docs/img/slack-apps/tutorials/asana-tutorial/json2.png)

8. Try your new Slash command. A modal should appear. Fill in the modal and hit
   submit to get a new error message:

![slack-apps/tutorials/asana-tutorial/asanaerror.png](/docs/img/slack-apps/tutorials/asana-tutorial/asanaerror.png)
...
![slack-apps/tutorials/asana-tutorial/payload.png](/docs/img/slack-apps/tutorials/asana-tutorial/payload.png)

9. Now grab all of your important values from your modal fields:

![slack-apps/tutorials/asana-tutorial/payloaddata.png](/docs/img/slack-apps/tutorials/asana-tutorial/payloaddata.png)

10. Use the [`Asana::createTask`](....\packages.md#createTask) and the
    `lookUpProjectID` functions to create your new task.

![slack-apps/tutorials/asana-tutorial/createtask.png](/docs/img/slack-apps/tutorials/asana-tutorial/createtask.png)

11. Respond with a `200`.

![slack-apps/tutorials/asana-tutorial/200.png](/docs/img/slack-apps/tutorials/asana-tutorial/200.png)

12. Check Asana - your new task should be visible in the project your specified
    project.

![slack-apps/tutorials/asana-tutorial/mytask.png](/docs/img/slack-apps/tutorials/asana-tutorial/mytask.png)
