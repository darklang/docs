...
Tuple support is currently thin - creating tuples of size greater than 3 is not
recommended at this time, as deconstructing tuples is not yet available.

- Tuples can be created, deconstructed (`let (lat, long) = (39.9526, 75.1652)`),
  and used in literal `match` patterns
