...
![ngstarted/Screen_Shot_2020-02-11_at_9.10.26_AM.png](/docs/img/gettingstarted/Screen_Shot_2020-02-11_at_9.10.26_AM.png)

2. Enter the HTTP verb as `GET` and `/math` for the route.

![ngstarted/Screen_Shot_2020-02-11_at_9.11.23_AM.png](/docs/img/gettingstarted/Screen_Shot_2020-02-11_at_9.11.23_AM.png)
...
![ngstarted/Screen_Shot_2020-02-11_at_9.12.02_AM.png](/docs/img/gettingstarted/Screen_Shot_2020-02-11_at_9.12.02_AM.png)

4. Click the handler's menu (☰) in the upper right and select "open in new tab",
   to see your API endpoint running in production.

![ngstarted/Screen_Shot_2020-02-11_at_9.12.43_AM.png](/docs/img/gettingstarted/Screen_Shot_2020-02-11_at_9.12.43_AM.png)

5. Go back to Dark to edit your code. Add `+ 5` to the end of the code and leave
   your cursor in line.

![ngstarted/Screen_Shot_2020-02-11_at_9.14.25_AM.png](/docs/img/gettingstarted/Screen_Shot_2020-02-11_at_9.14.25_AM.png)
...
![ngstarted/Screen_Shot_2020-02-11_at_9.16.06_AM.png](/docs/img/gettingstarted/Screen_Shot_2020-02-11_at_9.16.06_AM.png)
...
![ngstarted/Screen_Shot_2020-02-11_at_9.20.25_AM.png](/docs/img/gettingstarted/Screen_Shot_2020-02-11_at_9.20.25_AM.png)
...
![ngstarted/Screen_Shot_2020-02-11_at_9.21.21_AM.png](/docs/img/gettingstarted/Screen_Shot_2020-02-11_at_9.21.21_AM.png)

4. Hit enter to add the function into the handler.

![ngstarted/Screen_Shot_2020-02-11_at_9.22.01_AM.png](/docs/img/gettingstarted/Screen_Shot_2020-02-11_at_9.22.01_AM.png)
...
![ngstarted/Screen_Shot_2020-02-11_at_9.24.08_AM.png](/docs/img/gettingstarted/Screen_Shot_2020-02-11_at_9.24.08_AM.png)
...
![ngstarted/Screen_Shot_2020-02-11_at_10.41.50_AM.png](/docs/img/gettingstarted/Screen_Shot_2020-02-11_at_10.41.50_AM.png)
...
![ngstarted/Screen_Shot_2020-02-11_at_10.42.45_AM.png](/docs/img/gettingstarted/Screen_Shot_2020-02-11_at_10.42.45_AM.png)

8. Hitting play we receive a 404 response. This is because there's no `/test`
   endpoint on our canvas (yet!)

![ngstarted/Screen_Shot_2020-02-11_at_10.43.39_AM.png](/docs/img/gettingstarted/Screen_Shot_2020-02-11_at_10.43.39_AM.png)

9. 404s in Dark appear in the 404 section of the sidebar. We'll discuss that
   more later.

![ngstarted/Screen_Shot_2020-02-11_at_10.44.10_AM.png](/docs/img/gettingstarted/Screen_Shot_2020-02-11_at_10.44.10_AM.png)
...
![ngstarted/Screen_Shot_2020-02-11_at_10.44.54_AM.png](/docs/img/gettingstarted/Screen_Shot_2020-02-11_at_10.44.54_AM.png)
...
![ngstarted/Screen_Shot_2020-02-11_at_10.45.57_AM.png](/docs/img/gettingstarted/Screen_Shot_2020-02-11_at_10.45.57_AM.png)
...
![ngstarted/Screen_Shot_2020-02-11_at_10.47.10_AM.png](/docs/img/gettingstarted/Screen_Shot_2020-02-11_at_10.47.10_AM.png)
...
![ngstarted/Screen_Shot_2020-02-11_at_10.48.24_AM.png](/docs/img/gettingstarted/Screen_Shot_2020-02-11_at_10.48.24_AM.png)

In this case, we want `DB::set`, which takes three arguments.

![ngstarted/Screen_Shot_2020-02-11_at_10.48.51_AM.png](/docs/img/gettingstarted/Screen_Shot_2020-02-11_at_10.48.51_AM.png)
...
![ngstarted/datastore.png](/docs/img/gettingstarted/datastore.png)
...
![ngstarted/Screen_Shot_2020-02-11_at_10.57.58_AM.png](/docs/img/gettingstarted/Screen_Shot_2020-02-11_at_10.57.58_AM.png)
...
![ngstarted/Screen_Shot_2020-02-11_at_10.59.24_AM.png](/docs/img/gettingstarted/Screen_Shot_2020-02-11_at_10.59.24_AM.png)

8. The final argument is the Datastore: `Requests`.

![ngstarted/Screen_Shot_2020-02-11_at_11.00.04_AM.png](/docs/img/gettingstarted/Screen_Shot_2020-02-11_at_11.00.04_AM.png)
...
![ngstarted/Screen_Shot_2020-02-11_at_11.00.55_AM.png](/docs/img/gettingstarted/Screen_Shot_2020-02-11_at_11.00.55_AM.png)
...
![ngstarted/Screen_Shot_2020-02-11_at_11.01.32_AM.png](/docs/img/gettingstarted/Screen_Shot_2020-02-11_at_11.01.32_AM.png)
...
![ngstarted/newworker.png](/docs/img/gettingstarted/newworker.png)
...
![ngstarted/humandate.png](/docs/img/gettingstarted/humandate.png)

3. The `event` we received is not the exact shape we want. Let's process it
   using `List::map` to keep just the `data` field.

![ngstarted/dataonly.png](/docs/img/gettingstarted/dataonly.png)
...
![ngstarted/seconddatastore.png](/docs/img/gettingstarted/seconddatastore.png)

5. To get the count, use `List::length`. Then we store it in the DB, using
   `humanDate` as the key.

![ngstarted/dbsetworker.png](/docs/img/gettingstarted/dbsetworker.png)
...
![ngstarted/newworker.png](/docs/img/gettingstarted/dbgetalldaily.png)

3. Open a pipeline by typing `|>`, and pipe into a `List::map`, and create
   variables `date` and `count`.

![ngstarted/newworker.png](/docs/img/gettingstarted/functionmapvariable.png)

4. Pipe `val.count` into `toString` (shift-enter on a selected area also pipes
   that expression).

![ngstarted/newworker.png](/docs/img/gettingstarted/valcounttostring.png)

5. Return `date ++ ": " ++ count` in the last line of the block.

![ngstarted/newworker.png](/docs/img/gettingstarted/blockend.png)
...
![ngstarted/newworker.png](/docs/img/gettingstarted/selectall.png)

7. Type `Ctrl-\` (Control-Backslash) to open the command palette, then select
   `extract-function`.

![ngstarted/newworker.png](/docs/img/gettingstarted/extractfunction.png)

8. This creates the function, and replaces the existing code with a call to the
   new function.

![ngstarted/newworker.png](/docs/img/gettingstarted/extractedfunction.png)

9. Click on the function reference on the right hand side of the handler to go
   to the function and rename it.

![ngstarted/newworker.png](/docs/img/gettingstarted/functionspace.png)
...
![ngstarted/newworker.png](/docs/img/gettingstarted/functioncall.png)
...
- In the base, create two columns, one for date (field type is date) and one for
  ...
  ![ngstarted/newworker.png](/docs/img/gettingstarted/airtable_base.png)
- Generate an API key on the [Account page](https://airtable.com/account). Put
  the API key in a function in your Dark canvas.
  ![ngstarted/newworker.png](/docs/img/gettingstarted/airtable_key.png)
- Airtable's full API documentation for your base will be available on the
  ...
  ![ngstarted/newworker.png](/docs/img/gettingstarted/airtable_url.png)
...
![ngstarted/newworker.png](/docs/img/gettingstarted/apiworker_newline.png)

3. The `HttpClient::post` function takes four arguments. Paste the URI from
   Airtable from the base into the first argument.

![ngstarted/newworker.png](/docs/img/gettingstarted/api_httpclientpost.png)
...
![ngstarted/newworker.png](/docs/img/gettingstarted/api_header.png)
...
![ngstarted/newworker.png](/docs/img/gettingstarted/api_body.png)
...
![ngstarted/newworker.png](/docs/img/gettingstarted/api_success.png)
...
![ngstarted/newworker.png](/docs/img/gettingstarted/api_error.png)
...
- Change your REPL to say `"test3"` instead of `"test1"` and then re-run the
  ...
  ![ngstarted/Screen_Shot_2020-02-11_at_11.04.01_AM.png](/docs/img/gettingstarted/Screen_Shot_2020-02-11_at_11.04.01_AM.png)

- A new trace dot will appear on the HTTP Post `/test` handler. It shows
  `"test6"` in the body of the request.

  ![ngstarted/Screen_Shot_2020-02-11_at_11.04.07_AM.png](/docs/img/gettingstarted/Screen_Shot_2020-02-11_at_11.04.07_AM.png)
...
![ngstarted/airtable_skip_cron.png](/docs/img/gettingstarted/airtable_skip_cron.png)
