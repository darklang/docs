...
![gettingstarted/newworker.png](/docs/img/gettingstarted/newworker.png)
...
![gettingstarted/humandate.png](/docs/img/gettingstarted/humandate.png)

3. The `event` we received is not the exact shape we want. Let's process it
   using `List::map` to keep just the `data` field.

![gettingstarted/dataonly.png](/docs/img/gettingstarted/dataonly.png)
...
![gettingstarted/seconddatastore.png](/docs/img/gettingstarted/seconddatastore.png)

5. To get the count, use `List::length`. Then we store it in the DB, using
   `humanDate` as the key.

![gettingstarted/dbsetworker.png](/docs/img/gettingstarted/dbsetworker.png)
