...
![functional/image2.gif](/docs/img/nctional/image2.gif)
...
![functional/Image6.png](/docs/img/nctional/image6.png)
...
![functional/image9.png](/docs/img/nctional/image9.png)

### How to Pipe

To start a pipeline, use `|>` at the end of the expression you are piping.

![functional/openpipe.png](/docs/img/nctional/openpipe.png)
...
![functional/openpipe.png](/docs/img/nctional/selectpipe.png)
![functional/openpipe.png](/docs/img/nctional/successfulpipe.png)
...
![functional/image13.png](/docs/img/nctional/image13.png)
...
![functional/image4.png](/docs/img/nctional/image4.png)

In this case, we multiply each value by two:

![functional/image17.png](/docs/img/nctional/image17.png)
...
![functional/image14.png](/docs/img/nctional/image14.png)
...
![functional/listmap1.png](/docs/img/nctional/listmap1.png)

List map with a side effect, appears to use the same Int::random each time:

![functional/listmap2.png](/docs/img/nctional/listmap2.png)

List map with side effect, discrepancy between analysis and values stored in DB:

![functional/listmap3.png](/docs/img/nctional/listmap3.png)
...
![functional/block.png](/docs/img/nctional/block.png)
...
![functional/block.png](/docs/img/nctional/blockfilter.png)
...
![functional/image16.png](/docs/img/nctional/image16.png)
