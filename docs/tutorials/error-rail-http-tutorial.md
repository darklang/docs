...
![error-rail/pokeSearch.png](/img/error-rail/pokeSearch.png)
...
![error-rail/ditto.png](/img/error-rail/ditto.png)

3. Return to your function and check your traces - you should see a new one with
   `"ditto".`

![error-rail/dittoTrace.png](/img/error-rail/dittoTrace.png)

4. Create your URL by concatenating `https://pokeapi.co/api/v2/pokemon/` with
   your parameter.

![error-rail/url.png](/img/error-rail/url.png)

5. Write your `HttpClient::get` call.

![error-rail/data.png](/img/error-rail/data.png)
...
![error-rail/returnData.png](/img/error-rail/returnData.png)
...
![error-rail/error.png](/img/error-rail/error.png)
...
![error-rail/errorpoint.png](/img/error-rail/errorpoint.png)
