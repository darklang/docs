...
![reactspa/image15.gif](/docs/img/reactspa/image15.gif)
...
![reactspa/image24.png](/docs/img/reactspa/image24.png)

Now, let’s put the assets at the base of our API by creating a new route named
`/` from the omnibox, or the side bar:

![reactspa/image22.png](/docs/img/reactspa/image22.png)

Once the route is created, we can specify it’s a `GET` method, and start writing
code.

![reactspa/image2.png](/docs/img/reactspa/image2.png)

![reactspa/image21.png](/docs/img/reactspa/image21.png)
...
![reactspa/image4.png](/docs/img/reactspa/image4.png)

When you open the page it looks like this:

![hassets/reactspa/image29.png](/docs/img/reactspa/image29.png)
...
![reactspa/image3.png](/docs/img/reactspa/image3.png)
...
![reactspa/image7.png](/docs/img/reactspa/image7.png)
...
![reactspa/image6.png](/docs/img/reactspa/image6.png)
...
![reactspa/image14.png](/docs/img/reactspa/image14.png)
...
![reactspa/image34.png](/docs/img/reactspa/image34.png)
...
![reactspa/image19.png](/docs/img/reactspa/image19.png)

Then, you can update the hosts API to use our data storage.

![reactspa/image5.png](/docs/img/reactspa/image5.png)
...
![reactspa/image26.png](/docs/img/reactspa/image26.png)
...
![reactspa/image17.png](/docs/img/reactspa/image17.png)
...
![reactspa/mage28.png](/docs/img/reactspa/image28.png)
...
![reactspa/image9.png](/docs/img/reactspa/image9.png)
...
![reactspa/image23.png](/docs/img/reactspa/image23.png)
...
![reactspa/image11.png](/docs/img/reactspa/image11.png)
...
![reactspa/image33.png](/docs/img/reactspa/image33.png)
...
![reactspa/image30.png](/docs/img/reactspa/image30.png)

When created, the worker will have the event information as a trace:

![reactspa/image10.png](/docs/img/reactspa/image10.png)
...
![reactspa/image12.png](/docs/img/reactspa/image12.png)
...
![reactspa/image8.png](/docs/img/reactspa/image8.png)
...
![reactspa/image31.png](/docs/img/reactspa/image31.png)

Finally, we have to make the post request, which takes four parameters,
including a body.

![reactspa/image25.png](/docs/img/reactspa/image25.png)

You can fill them in as follows from the above code:

![reactspa/image13.png](/docs/img/reactspa/image13.png)

When you hit play, you should receive a DM from your Slackbot, as well as an
inline API response.

![reactspa/image16.png](/docs/img/reactspa/image16.png)
