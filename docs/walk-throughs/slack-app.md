...
Please don’t use the Darklang community Slack, as it’s a free community and we can’t
support them all.
...
In Darklang, you work with production traces to build your backend. **Click on the
...
Slack made to your Darklang app. This includes the code you’ll need to send back to
Slack.
...
Type the code below into your handler in Darklang. As you enter it, you’ll see that
...
Request URL, which is just a URL pointing to your Darklang app, in the same format
as before:
...
after triggering it in Slack (and it would appear in your 404 section in Darklang).
